...
> Generated: 2026-07-08T00:14:05.124Z
> Matched docs (DOI): **23408**

## Summary

| field | match | drift | registry-only | canonical-only | both-empty |
|---|---:|---:|---:|---:|---:|
| title | 21114 | **2294** | 0 | 0 | 0 |
| pubYear | 23403 | **5** | 0 | 0 | 0 |
| pubMonth | 21014 | **2394** | 0 | 0 | 0 |
| authors | 10350 | **60** | 40 | 15 | 12943 |
| abstract | 8509 | **109** | 155 | 462 | 14173 |
| keywords | 0 | **0** | 1 | 305 | 23102 |
| journalTitle | 0 | **0** | 0 | 23408 | 0 |
...
## Drift — title (2294, first 50 shown)
...
## Drift — pubMonth (2394, first 50 shown)
...
## Drift — authors (60, first 50 shown)
...
## Drift — abstract (109, first 50 shown)
