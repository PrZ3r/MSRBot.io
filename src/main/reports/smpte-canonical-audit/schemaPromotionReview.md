...
> Generated: 2026-07-07T23:21:42.553Z
> Input: sourceFieldCensus.paths.json
> Data-bearing unmapped paths: **1037**

| verdict | paths | shape variants dedupe |
|---|---:|---:|
| 🎯 PROMOTE (new schema field) | 7 | 4 distinct |
| ✅ MAP (variant of existing schema field) | 21 | 10 distinct |
| 🗑️ SKIP | 414 + 296 attrs | — |
| ❓ REVIEW (no heuristic) | 299 | — |
...
| **conferenceLocation** | `publication/publicationinfo/confgroup/conflocation` (1923)<br>`content_batch/body/conference/conference_metadata/meeting_location` (76) | 1923 | `Los Angeles, CA, USA` · `New York, NY, USA` · `Montreal, QC, Canada` |
...
|---|---|---:|---|
| `journalTitle` | `publication/normtitle`<br>`content_batch/body/journal/journal_metadata/normalized_title`<br>`article/front/journal-meta/journal-title-group/journal-title`<br>`content_batch/body/conference/conference_metadata/normalized_title` | 25684 | IDAMS variant of journal title (already in schema) |
...
| `keywords` | `publication/volume/article/articleinfo/keywordset/keyword/keywordterm`<br>`content_batch/body/journal/journal_article/index_terms/term`<br>`content_batch/body/conference/conference_article/index_terms/term` | 1107 | IDAMS keyword atom |
...
| `content_batch` | `content_batch/body/conference/conference_metadata/ieee_acronym` | 76 | `MTS` |
| `content_batch` | `content_batch/body/conference/conference_article/show_flag` | 76 | `Y` · `N` |
| `content_batch` | `content_batch/body/conference/conference_issue/conference_date/@start_day` | 76 | `21` · `13` |
| `content_batch` | `content_batch/body/conference/conference_issue/conference_date/@start_month` | 76 | `Oct.` |
| `content_batch` | `content_batch/body/conference/conference_issue/conference_date/@end_day` | 76 | `24` · `16` |
| `content_batch` | `content_batch/body/conference/conference_issue/conference_date/@end_month` | 76 | `Oct.` |
...
| `content_batch` | `content_batch/body/conference/conference_article/contributors/author/person_name/email_address` | 28 | `t.bruylants@intopix.com` · `b.runyan@intopix.com` · `jb.lorent@intopix.com` |
...
_… 239 more (see JSON)_

## 🗑️ SKIP — filed for the record

- 414 structural / boilerplate / delivery-metadata / editorial-workflow paths
